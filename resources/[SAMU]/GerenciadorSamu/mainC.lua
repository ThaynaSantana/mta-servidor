...
function painel_corp()
    if State == 'Home' then
        ...
        dxDrawText("Gerenciador SAMU", 735, 405, 450, 60, tocolor(255, 255, 255, 255), 1, font[2], "center", "center", true, true, true)
    ...
    elseif State == 'Fardas' then
        ...
        dxDrawText("Gerenciador SAMU", 735, 300, 450, 60, tocolor(255, 255, 255, 255), 1, font[2], "center", "center", true, true, true)
