...
addEventHandler('onClientRender', root,
	function()
		for k, v in pairs(notificationData) do
			...
			if (v.Alpha == 255) then
				dxDrawRectangle(v.CurrentX + 30, 20, 15 + v.CurrentWidth, 26, tocolor(0, 0, 0, 150), false);
