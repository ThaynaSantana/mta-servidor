...
function SimpleStats()
        local Jogador_Falando = getElementData(localPlayer, "Falando_") or false
                                                                                                                                              -- Ativando # = True
        dxDrawText("*Modo: #FFFF00Normal", x*376, y*681, x*460, y*696, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, false, true, false)		

        if Jogador_Falando == true then                                                                                                      -- Ativando # = True
        dxDrawText("*Voz: #00ff00Ativado", x*376, y*662, x*460, y*677, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, false, true, false)
        else
        	                                                                                                                                     -- Ativando # = True
        dxDrawText("*Voz: #FF0000Desativado", x*376, y*662, x*460, y*677, tocolor(255, 255, 255, 255), 1.00, "default-bold", "left", "top", false, false, false, true, false)
    end
end
